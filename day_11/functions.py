...
# print(f'1. {is_prime(4)}')


# def is_unique_list(*unique_list):
...
# print(f'2. {is_unique_list(2, True, "foo", 3.5, "bar")}')


# def same_type(*items):
#     ''' Checks if all items are the same data type '''
#     for idx in range(1, len(items)):
#         if type(items[idx]) is not type(items[idx - 1]):
#             return False
#     return True


# print(f'3. {same_type(2, 3, 3.5)}')


# def is_valid_variable(value):
#     ''' Checks if value is a valid variable '''
#     return hasattr()


# name = 'leke'

# print(f'4. {is_valid_variable(name)}')
...
#     capitalized_list = []
#     for item in lst:
#         capitalized_list.append(item.title())

#     return capitalized_list


# print(capitalize('a', 'c', 'add'))
